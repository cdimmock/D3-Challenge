...
var labelArea = 110;
//padding for text at bottom and left
var tPadBot = 40;
var tPadLeft = 40;
...
// set radius for each dot in graph
var circRadius;
    function crGet() {
        if (width <= 530) {
            circRadius = 5;
...
//xText allows group selection without excess text(Remember This!)
var xText = d3.select("xText");

//transformative property added to xText to put it at the bottom of the chart
//nesting it in a function allows easy location change if window width changes
...
//use xText to append Poverty to SVG files
...
//Specifying variables to make transform attributes more readable 
 var leftTextX = margin + tPadLeft;
 var leftTextY = (height + labelArea) / 2 - labelArea;

//  second label group for left chart axis
svg.append("g").attr("class", "yText");

// yText allows easy group selection
...
//nest yText for an easy change function if needed for window change
yText
  .append("text")
  .attr("y", -26)
...
// ===========================================Import csv file=========================================================
// data file has stat-by-state demographic data from US census
...
// call viz function on data to handle manipulation of visual elements
function visualize(theData) {
    // Local variables and functions used here
    // curX and curY will determine what is represented where
    // defaults have the same name as headings in CSV
    var curX = "poverty";
    var curY = "healthcare";
    ...
    //==================================== 
    // these funcs will remove repition from later code
...
svg.call(toolTip);
    ...
    function xMinMax() {
        // min grabs smallest data from selected column
        xMin = d3.min(theData, function(d) {
            return parseFloat(d[curX]) * 0.90;
        });
        //max grabs biggest data from selected column
...
// =========================Scatter Plot=============================================
// adds first placement of data and axes to scatter plot

// grab min and max values for x and y first
xMinMax();
yMinMax();

// min and max defined values->create scales
var xScale = d3
    .scaleLinear()
    .domain([xMin, xMax])
...
var yScale = d3
    .scaleLinear()
    .domain([yMin, yMax])
    // height is inverse cuz d3 has weird y-axis placement
...
// calling them includes all numbers, borders, and ticks
// transform attributes specifies where to place axes
svg
    .append("g")
    .call(xAxis)
    .attr("class", "xAxis")
...
// group for dots and their labels
var theCircles = svg.selectAll("g theCircles").data(theData).enter();

// append the circles for state
theCircles
    .append("circle")
